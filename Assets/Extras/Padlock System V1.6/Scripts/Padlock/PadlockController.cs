...
namespace PadlockSystem
{
    public class PadlockController : MonoBehaviour
    {
        ...
        [Header("Audio Names")]
        [SerializeField] private Sound padlockInteractSound = null;
        [SerializeField] private Sound padlockSpinSound = null;
        [SerializeField] private Sound padlockUnlockSound = null;
        ...
        public void ShowPadlock()
        {
            ...
            CamN.transform.localEulerAngles = new Vector3(0, 0, 0);
            InteractSound();
        ...
        void SpawnPadlock(float distance)
        {
            ...
            GameObject padlockInstance = Instantiate(padlockPrefab, CamN.transform);
